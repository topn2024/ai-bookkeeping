...
**VoiceServiceCoordinator.dart (4,063行)**
- 违反单一职责原则，承担15+种不同职责
- 30个处理方法，31个依赖注入
...
| 指标 | 当前值 | 目标值 | 优先级 |
|------|--------|--------|--------|
| VoiceServiceCoordinator LOC | 4,063 | <300 | P0 |
| DatabaseService LOC | 4,448 | <200/repo | P0 |
| GlobalVoiceAssistantManager LOC | 2,782 | <500 | P1 |
| SmartIntentRecognizer LOC | 2,482 | <500 | P1 |
| 每类依赖数 | 17+ | <5 | P0 |
| 每类方法数 | 196 | <20 | P0 |
| 单元测试覆盖率 | 未知 | >80% | P1 |
| 循环依赖 | 高风险 | 0 | P0 |
