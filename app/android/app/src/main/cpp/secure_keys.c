...
static const unsigned char AK_ID_ENC[] = {
    0x07, 0x0E, 0x7D, 0x38, 0x1B, 0xEE, 0x57, 0xB3,
    0x3D, 0x2C, 0x6A, 0x27, 0x74, 0xD7, 0x71, 0xC9,
    0x3F, 0x2C, 0x71, 0x36, 0x73, 0xFD, 0x49, 0xA0
};
static const size_t AK_ID_LEN = 24;

// 阿里云 AccessKey Secret (XOR加密后的字节数组)
static const unsigned char AK_SEC_ENC[] = {
    0x26, 0x68, 0x50, 0x33, 0x41, 0xCA, 0x24, 0xDA,
    0x78, 0x30, 0x4B, 0x37, 0x5E, 0xCE, 0x20, 0xEB,
    0x0F, 0x27, 0x4F, 0x0C, 0x1B, 0xB1, 0x55, 0xE3,
    0x11, 0x30, 0x5D, 0x12, 0x4D, 0xEC
};
static const size_t AK_SEC_LEN = 30;

// 阿里云 AppKey (XOR加密后的字节数组)
static const unsigned char APP_KEY_ENC[] = {
    0x08, 0x62, 0x7A, 0x4F, 0x42, 0xE4, 0x2D, 0xE2,
    0x23, 0x2C, 0x51, 0x03, 0x65, 0xD2, 0x25, 0xCC
};
static const size_t APP_KEY_LEN = 16;

// 通义千问 API Key (XOR加密后的字节数组)
static const unsigned char QWEN_ENC[] = {
    0x38, 0x31, 0x59, 0x39, 0x1E, 0xAA, 0x0E, 0xB9,
    0x7A, 0x6C, 0x09, 0x1A, 0x1B, 0xAD, 0x0E, 0xBA,
    0x7B, 0x6E, 0x4B, 0x14, 0x13, 0xB9, 0x28, 0xBC,
    0x68, 0x3D, 0x08, 0x00, 0x13, 0xAD, 0x01, 0xA9,
    0x7A, 0x0D
};
