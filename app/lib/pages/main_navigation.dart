...
class _MainNavigationState extends ConsumerState<MainNavigation>
  ...
  void initState() {
    ...
    _pages = [
      ...
      EnhancedVoiceAssistantPage(onBack: _goToHome),  // 白记宠物助手
      const SettingsPage(),
    ];
  ...
  Widget _buildCenterButton(BuildContext context) {
    return Transform.translate(
      ...
      child: Container(
        key: _mainNavXiaojiNavKey,  // 白记按钮的key（用于功能引导）
